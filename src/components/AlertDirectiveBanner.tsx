...
export const AlertDirectiveBanner: React.FC<AlertDirectiveBannerProps> = ({
  ...
  return (
    <section className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 mt-6">
      <div
        className={`rounded-lg border p-4 sm:p-5 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-sm transition-all ${
          isCriticalOrHigh
      ...
      >
        ...
        <div className="flex items-start gap-3.5">
          ...
          <div className="space-y-1">
            ...
            <h2
              className={`font-heading font-extrabold text-lg sm:text-xl tracking-tight leading-snug ${
            ...
            <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-300 font-normal leading-relaxed max-w-3xl">
        ...
        <div className="flex items-center gap-2.5 flex-shrink-0 self-start md:self-center">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded bg-[#ba1a1a] hover:bg-[#991b1b] active:bg-[#7f1d1d] text-white text-xs sm:text-sm font-semibold tracking-wide shadow-sm transition-colors whitespace-nowrap"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 active:bg-slate-100 text-slate-800 dark:text-slate-200 border border-slate-300 dark:border-slate-700 text-xs sm:text-sm font-semibold tracking-wide transition-colors shadow-2xs whitespace-nowrap"
          >
