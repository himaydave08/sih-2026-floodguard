...
export const InteractiveMap: React.FC<InteractiveMapProps> = ({
  ...
  const sectorCoordinatesMap: Record<string, { x: number; y: number }> = {
    ...
    bajali: { x: 130, y: 340 },
    barpeta: { x: 120, y: 380 },
    biswanath: { x: 350, y: 250 },
    bongaigaon: { x: 80, y: 400 },
    cachar: { x: 280, y: 550 },
    charaideo: { x: 600, y: 320 },
    chirang: { x: 100, y: 350 },
    darrang: { x: 220, y: 330 },
    dhubri: { x: 30, y: 420 },
    dimahasao: { x: 320, y: 480 },
    goalpara: { x: 90, y: 430 },
    golaghat: { x: 400, y: 380 },
    hailakandi: { x: 250, y: 580 },
    hojai: { x: 330, y: 420 },
    jorhat: { x: 450, y: 320 },
    kamrup: { x: 180, y: 380 },
    kamrupmetropolitan: { x: 200, y: 400 },
    karbianglong: { x: 380, y: 420 },
    karimganj: { x: 220, y: 590 },
    kokrajhar: { x: 50, y: 350 },
    morigaon: { x: 280, y: 390 },
    nagaon: { x: 320, y: 380 },
    nalbari: { x: 160, y: 360 },
    sivasagar: { x: 520, y: 300 },
    sonitpur: { x: 300, y: 270 },
      "southsalmara-mankachar": { x: 40, y: 480 },
    tamulpur: { x: 170, y: 330 },
    udalguri: { x: 200, y: 300 },
    westkarbianglong: { x: 300, y: 430 },
  };
