...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer className="mt-14 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 transition-colors">
      {/* Statutory Notice Strip */}
      <div className="bg-[#eff4ff] dark:bg-slate-800/80 border-b border-sky-100 dark:border-slate-800 py-3.5 px-4 sm:px-6 lg:px-8">
        <div className="max-w-[1440px] mx-auto flex items-start gap-3 text-xs text-sky-950 dark:text-sky-200 font-normal leading-relaxed">
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-700 dark:text-slate-300">
              <li className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-1">
                <span>State EOC Assam (SEOC):</span>
                <span className="font-mono font-bold text-slate-900 dark:text-slate-100">1070 / 1079</span>
              </li>
              <li className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-1">
                <span>NDRF 1st Bn Guwahati:</span>
                <span className="font-mono font-bold text-slate-900 dark:text-slate-100">0361-2849033</span>
              </li>
              <li className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-1">
                <span>SDRF Assam Control:</span>
                <span className="font-mono font-bold text-slate-900 dark:text-slate-100">0361-2237011</span>
              </li>
            </ul>
          </div>
